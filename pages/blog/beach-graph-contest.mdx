...
<br/>
<br/>
<div clasName="markdown-body t-20">
# Beach/Summer Graph Contest
<Author contributors={["manuanish"]} readTime={5}/>
<br/>
---
In this post I will be explaining how I created my graph for the [Beach/Summer Graph Contest](https://princetonk12.instructure.com/courses/6508/discussion_topics/213397).
<br/>
<br/>
### Defining the pixel
Let's begin by looking at the graph of the following function. For *each pixel* I have used the following polar graph:
...
Using the python library `Pillow`, we can get the exact colors of pixels at certain points in an image. This can be done quite easily like so:
<br/>
<br/>
```py
...
<br/>
<br/>
<BlogImage src="/blog/small-beach.jpg" width={400} height={400} caption="Image source: Microsoft"/>
<br/>
<br/>
If we run the script, we obtain the following image:
<br/>
<br/>
<BlogImage src="/blog/output.png" width={500} height={500} caption="Final graph."/>
<br/>
<br/>
Notice that the image is rotated. Why is this? Because of the way the pixels were graphed the image turns out to be $90^\circ$ rotated than
